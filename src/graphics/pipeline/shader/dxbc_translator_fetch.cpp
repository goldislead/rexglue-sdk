...
void DxbcShaderTranslator::ProcessTextureFetchInstruction(
  ...
  if (instr.opcode == FetchOpcode::kGetTextureWeights) {
    ...
    if (instr.opcode == FetchOpcode::kTextureFetch) {
      ...
      dxbc::Dest integer_scale_bits_dest(dxbc::Dest::R(integer_scale_bits_temp,
                                                       used_result_nonzero_components));
      ...
      dxbc::Src integer_scale_bits_packed =
          LoadSystemConstant(SystemConstants::Index::kTextureIntegerScaleBits,
                             ...
                             dxbc::Src::kXXXX);
      // Zero means leave the sample alone. Only integer num_format on fixed
      // textures has scale bits.
      a_.OpIf(true, integer_scale_bits_packed);
      a_.OpUBFE(integer_scale_bits_dest, dxbc::Src::LU(5), dxbc::Src::LU(0, 5, 10, 15),
      ...
      a_.OpUShR(integer_scale_bits_dest, integer_scale_bits_src, dxbc::Src::LU(4));
