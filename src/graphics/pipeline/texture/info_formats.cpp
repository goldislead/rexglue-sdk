...
#define FORMAT_INFO(texture_format, format, block_width, block_height, bits_per_pixel, \
                    component_bits_0, component_bits_1, component_bits_2, component_bits_3, \
                    fixed) \
  {xenos::TextureFormat::texture_format, #texture_format, FormatType::format, block_width, \
   block_height, bits_per_pixel, {component_bits_0, component_bits_1, component_bits_2, \
                                  component_bits_3}, \
   fixed}
const FormatInfo* FormatInfo::Get(uint32_t gpu_format) {
  static const FormatInfo format_infos[64] = {
      ...
      FORMAT_INFO(k_8_8_8_8_AS_16_16_16_16, kResolvable, 1, 1, 32, 8, 8, 8, 8,
                  true),
      FORMAT_INFO(k_DXT1_AS_16_16_16_16, kCompressed, 4, 4, 4, 0, 0, 0, 0,
                  false),
      ...
      FORMAT_INFO(k_DXT4_5_AS_16_16_16_16, kCompressed, 4, 4, 8, 0, 0, 0, 0,
                  false),
      FORMAT_INFO(k_2_10_10_10_AS_16_16_16_16, kResolvable, 1, 1, 32, 10, 10,
                  10, 2, true),
      FORMAT_INFO(k_10_11_11_AS_16_16_16_16, kResolvable, 1, 1, 32, 11, 11, 10,
                  0, true),
      FORMAT_INFO(k_11_11_10_AS_16_16_16_16, kResolvable, 1, 1, 32, 10, 11, 11,
                  0, true),
      ...
      FORMAT_INFO(k_8_8_8_8_GAMMA_EDRAM, kUncompressed, 1, 1, 32, 8, 8, 8, 8,
                  true),
      FORMAT_INFO(k_2_10_10_10_FLOAT_EDRAM, kUncompressed, 1, 1, 32, 0, 0, 0,
                  0, false),
  };
